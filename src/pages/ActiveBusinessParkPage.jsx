...
function BrochurePopup({ subpage, onClose }) {
  return <BrochureLeadPopup project="Active Business Park - Kolkata" city="Kolkata" slug="active-business-park" source="Active Business Park page brochure download" brochureUrl={subpage.brochureUrl} onClose={onClose} />;
}
