...
export function Footer() {
  ...
  const email = settings?.email || "emarketing@ruchirealty.com";
  const youtube = settings?.youtube || "https://www.youtube.com/@ruchirealtygroup";
  ...
  return (
    <footer className="footer">
      ...
      <div className="rr-wrap footer__inner">
        ...
        <aside className="footer__legal-note" aria-label="Legal note">
          <strong>Legal note</strong>
          <p>RERA details and approvals are available on respective project pages. Images are for representation unless mentioned as actual site photographs.</p>
        </aside>
