...
SET hero_title = 'Angelica - Active Acres',
    ...
    specifications = jsonb_build_array(
      ...
      jsonb_build_object('title','Project Details','desc','HIRA Registration No: HIRA/P/KOL/2020/000778. Contact: 033 6902 9144 | info@ruchirealty.com.','image','/projects/active-acres-angelica/gallery/gallery-4.webp'),
