/* ============================================================
   ...
   ============================================================ */
const { useState: uSP, useEffect: uEP, useRef: uR1 } = React;
...
function AboutHero() {
  ...
  uEP(() => {
    ...
    const onScroll = () => {
      ...
      raf = requestAnimationFrame(() => {
        ...
        if (vid.current && y < limit) {
          const scale = 1 + Math.min(y / limit, 1) * 0.12;
  ...
  return (
    <header className="ab-hero" data-screen-label="About us">
      <video ref={vid} className="ab-hero__video" src="uploads/about-hero.mp4"
        autoPlay muted loop playsInline preload="auto" aria-label="Ruchi Realty about showreel" />
      <div className="ab-hero__scrim"></div>
      ...
      <div className="rr-wrap ab-hero__wrap">
        ...
        {/* Floating Story Preview Chips Bar */}
        <div className="ab-hero__story-bar">
          <div className="ab-hero__story-chip">
            <span className="ab-hero__story-num">17+</span>
            <span className="ab-hero__story-lbl">Years of Real Estate Expertise</span>
          </div>
          <div className="ab-hero__story-divider"></div>
          <div className="ab-hero__story-chip">
            <span className="ab-hero__story-num">3</span>
            <span className="ab-hero__story-lbl">Key Indian Cities</span>
          </div>
          <div className="ab-hero__story-divider"></div>
          <div className="ab-hero__story-chip">
            <span className="ab-hero__story-num">40+</span>
            <span className="ab-hero__story-lbl">Landmark Addresses Delivered</span>
          </div>
        </div>
      </div>
    </header>
